...
{
    public const PURPOSE_TICKET_ACCESS = 'ticket_access';
    ...
    {
        return $query->where('communication_campaign_id', $campaignId);
    }
    ...
    public function channelLabel(): string
    {
        return match ($this->channel) {
            ...
            default => str($this->channel)->headline()->toString(),
        };
    }
    ...
    {
        return (string) ($this->attendee?->full_name ?: 'Unknown attendee');
    }
    ...
    public function syncCampaignRecipient(): void
    {
        ...
        $recipientStatus = match ($this->status) {
            self::STATUS_PENDING => CommunicationCampaignRecipient::STATUS_PENDING,
            self::STATUS_QUEUED => CommunicationCampaignRecipient::STATUS_QUEUED,
            self::STATUS_SENDING => CommunicationCampaignRecipient::STATUS_PROCESSING,
            self::STATUS_SENT => CommunicationCampaignRecipient::STATUS_SENT,
            self::STATUS_DELIVERED => CommunicationCampaignRecipient::STATUS_DELIVERED,
            self::STATUS_FAILED => CommunicationCampaignRecipient::STATUS_FAILED,
