            ...
            <div style="padding:28px;">
                ...
                @if ($attendee->status === 'pending_approval')
                    ...
                    ">
                        ...
                        Your badge will be available after the event organizer
                ...
                @elseif ($attendee->status === 'waitlisted')
                    ...
                    ">
                        ...
                        The organizer will contact you if a space becomes available.
                    </div>
                ...
                @else
                    ...
                    ">
                        ...
                        Please present your digital badge at the entrance for verification and check-in.
                    </div>
                ...
                ">
                    ...
                    ">
                        ...
                        <div style="
                            ...
                            margin-top:5px;
                        ">
                            {{ $attendee->category?->name ?: 'General' }}
                        </div>
                    </div>
                    ...
                    ">
                        ...
                        <div style="
                            ...
                            margin-top:5px;
                        ">
                            {{ $attendee->badgeType?->name ?: 'Default' }}
                        </div>
                    </div>
                    ...
                    ">
                        ...
                        @if ($attendee->hasBadge())
                            ...
                            <p style="
                                ...
                                line-height:1.6;
                            ">
                                Present this badge at the entrance.
                                The QR code printed on the badge will be scanned
                ...
                @if (
                    $attendee->registrationAnswers
                    && $attendee->registrationAnswers->count()
                )
