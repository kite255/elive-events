...
class TicketOrganizerFinanceAccessTest extends TestCase
{
    use RefreshDatabase;

    public function test_ticket_organizer_can_access_my_finance_page(): void
    {
        ...
        $this->assertTrue(
            OrganizerFinanceOverview::canAccess()
        );
    }
}